...
public interface CommonQueryService2017 {
    ...
    public List<CommonQueryResultDO> recommondationCommon(User u, CommonQueryDO commonQueryDO,String[] province,String[] levelOne,String[] levelTwo);
